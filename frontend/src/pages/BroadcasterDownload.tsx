...
import { Laptop, Cpu, Download, Info, CheckCircle2, ChevronRight, HelpCircle } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 bg-slate-900/40 border border-white/3 p-8 rounded-3xl space-y-6 shadow-xl relative overflow-hidden">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-450 leading-relaxed font-semibold">
              Get the standalone desktop broadcaster client. Capture live stereo streams directly from your soundcard or microphone, encode to MP3 in real-time, and route to your radio node.
            </p>
          </div>
          ...
          <div className="bg-slate-950/45 p-5 border border-white/3 rounded-2xl flex flex-col gap-4">
            ...
            <button
              onClick={() => showInfo("Broadcaster Download", `Initiating download: VeriSonic Broadcast Link client app for ${detectedOS}.`)}
            ...
            >
              <Download className="w-4.5 h-4.5" /> Download for {detectedOS}
            </button>

            {/* Alternative Platforms */}
            <div className="border-t border-white/5 pt-4 mt-2 space-y-2.5">
              <span className="text-[10px] text-slate-550 font-bold uppercase tracking-wider block">Other supported platforms:</span>
              <div className="grid grid-cols-2 gap-3 text-[10px] font-bold text-center uppercase tracking-wider">
                {alternatives.map(p => (
                  <button 
                    key={p}
                    onClick={() => showInfo("Broadcaster Download", `Initiating download: VeriSonic Broadcast Link client app for ${p}.`)}
        ...
        <div className="lg:col-span-5 bg-slate-900/40 border border-white/3 p-8 rounded-3xl space-y-6 shadow-xl relative overflow-hidden">
          ...
          <div className="space-y-5 text-xs text-slate-400">
            <div className="flex gap-3">
              ...
              <p className="leading-relaxed">
                <strong className="text-slate-200">Download & Run</strong> the software client matching your computer platform from this page.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <p className="leading-relaxed">
                Paste the copied Stream Key inside the desktop broadcaster client, select your audio source, and hit <strong className="text-slate-200">Connect Live</strong>.
              </p>
            </div>
          </div>
          ...
          <div className="border-t border-white/5 pt-4 text-[10px] text-slate-500 flex items-start gap-2 leading-relaxed">
            ...
            <span>
              If you require assistance configuring loopback devices (streaming system audio rather than your mic), refer to the bundled `distributing_broadcaster.md` document.
            </span>
          </div>
        </div>
