...
export const Settings: React.FC = () => {
  ...
  const isSuperAdmin = (currentUser?.real_role || currentUser?.role) === 'admin';
  ...
  const qualityGridClass = 'grid grid-cols-2 xl:grid-cols-4 gap-4';

  const streamQualitySection = (
  ...
  const subscriptionSection = (
    <section className="bg-slate-900/10 border border-white/3 p-6 rounded-3xl space-y-6 shadow-inner lg:sticky lg:top-6 min-w-0 relative overflow-hidden">
      {isPremium && (
