...
from app.api import auth, music, radio, playlists, analytics, favorites, reactions, subscriptions, wallet, revenue_admin, discovery, catalog, findlio_webhook
...
app.include_router(findlio_webhook.router, prefix="/api")
